...
export default function AdminDashboard() {
  ...
  if (!user || user.role !== 'admin') {
    return (
      <div className="min-h-screen bg-[#050506] text-light-gray flex items-center justify-center p-6 font-jakarta">
        <div className="w-full max-w-md glass-card bg-[#0B0B0C] p-8 rounded-3xl shadow-2xl border-red-500/25 space-y-6 text-center">
          ...
          <div className="space-y-2">
            <h2 className="font-heading text-xl font-extrabold text-white tracking-tight uppercase">Admin Access Required</h2>
          ...
          <form onSubmit={handleAdminLogin} className="space-y-3">
            <button 
              type="submit"
              className="w-full py-3.5 bg-red-500 hover:bg-red-600 text-white rounded-full font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-lg shadow-red-500/10"
            >
            ...
            <button 
              ...
              className="w-full py-2.5 bg-dark-gray hover:bg-gray-800 border border-card-border text-[10px] uppercase tracking-wider text-gray-300 rounded-full font-bold transition-all flex items-center justify-center gap-1.5"
            >
  ...
  return (
    <div className="space-y-10 pb-16 font-jakarta text-left">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <h1 className="font-heading text-3xl font-black text-white tracking-tight uppercase">Admin Control Panel</h1>
        </div>

        <button 
          onClick={() => router.push('/dashboard')}
          className="px-5 py-2.5 bg-dark-gray hover:bg-gray-800 border border-card-border rounded-full text-[10px] font-bold uppercase tracking-wider text-gray-300 transition-all flex items-center gap-1.5"
        >
        ...
        {[
          ...
          return (
            <div key={i} className="glass-card p-5 rounded-2xl flex flex-col justify-between h-[110px] bg-[#0D0D0F]">
              ...
              <div className="font-heading text-xl sm:text-2xl font-black text-white tracking-tight">{card.val}</div>
            </div>
          );
        })}
      </div>
      ...
      <div className="flex border-b border-card-border/80 text-[11px] font-bold uppercase tracking-wider text-gray-500">
        {[
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 glass-card rounded-2xl p-6 bg-[#0D0D0F] space-y-6">
            <div className="flex justify-between items-center">
              <h3 className="font-heading font-bold text-white text-base uppercase tracking-wider">Monthly Revenue Breakdown</h3>
              <span className="text-[10px] text-green-400 font-bold bg-green-500/10 px-2.5 py-1 rounded border border-green-500/20 uppercase tracking-wide">+18% this month</span>
            </div>
            ...
            <div className="h-64 flex items-end justify-between gap-4 pt-10 border-b border-card-border/60 pb-2 relative">
              ...
              {[
                ...
                <div key={i} className="flex-1 flex flex-col items-center gap-2 z-10 group">
                  ...
                  <div className="text-xs text-gray-500 font-bold mt-1 font-mono">{bar.month}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="lg:col-span-4 glass-card rounded-2xl p-6 bg-[#0D0D0F] space-y-6">
            <h3 className="font-heading font-bold text-white text-base uppercase tracking-wider">Recent Payments (Stripe)</h3>
            
            <div className="space-y-3 max-h-[260px] overflow-y-auto pr-1">
              {transactions.map((tx) => (
                <div key={tx.id} className="p-3.5 rounded-xl bg-black border border-card-border flex items-center justify-between text-xs">
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="glass-card rounded-2xl p-6 bg-[#0D0D0F] space-y-4">
              <h3 className="font-heading font-bold text-white text-sm flex items-center gap-2 uppercase tracking-wide">
              ...
              <form onSubmit={handleCreateModule} className="space-y-4 text-xs">
                <div className="space-y-1">
                  <label className="text-[9px] text-gray-400 uppercase font-bold tracking-wider">Module Title</label>
                  <input 
                    type="text" 
                    required 
                    ...
                    className="w-full px-3 py-2.5 bg-black border border-card-border rounded-lg text-white focus:outline-none focus:border-purple-500"
                  />
                </div>

                <div className="space-y-1">
                  <label className="text-[9px] text-gray-400 uppercase font-bold tracking-wider">Module Description</label>
                  <textarea 
                    rows={2}
                ...
                <button 
                  type="submit"
                  className="w-full py-3 bg-purple-500 hover:bg-purple-600 text-white rounded-full font-bold text-[10px] uppercase tracking-wider transition-all shadow-lg"
                >
                  Create Module
                </button>
              </form>
            ...
            <div className="glass-card rounded-2xl p-6 bg-[#0D0D0F] space-y-4">
              ...
              <form onSubmit={handleCreateLesson} className="space-y-3 text-xs">
                <div className="space-y-1">
                  <label className="text-[9px] text-gray-400 uppercase font-bold tracking-wider">Select Module</label>
                  <select 
                    required 
                    value={selectedModId}
                ...
                <div className="space-y-1">
                  <label className="text-[9px] text-gray-400 uppercase font-bold tracking-wider">Lesson Title</label>
                  <input 
                    type="text" 
                    required 
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="text-[9px] text-gray-400 uppercase font-bold tracking-wider">Duration</label>
                    <input 
                      type="text" 
                      required 
                      placeholder="18:30"
                      ...
                      className="w-full px-3 py-2.5 bg-black border border-card-border rounded-lg text-white focus:outline-none focus:border-purple-500 text-center"
                    />
                  </div>
                  <div className="space-y-1">
                    <label className="text-[9px] text-gray-400 uppercase font-bold tracking-wider">Difficulty</label>
                    <select 
                      value={newLessDiff}
                      onChange={(e) => setNewLessDiff(e.target.value as any)}
                      className="w-full px-3 py-2.5 bg-black border border-card-border rounded-lg text-white focus:outline-none"
                    >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="text-[9px] text-gray-400 uppercase font-bold tracking-wider">Resource File Name</label>
                    <input 
                      type="text" 
                  ...
                  <div className="space-y-1">
                    <label className="text-[9px] text-gray-400 uppercase font-bold tracking-wider">Resource Size</label>
                    <input 
                      type="text" 
                      placeholder="12.4 MB"
                ...
                <button 
                  type="submit"
                  className="w-full py-3 bg-purple-500 hover:bg-purple-600 text-white rounded-full font-bold text-[10px] uppercase tracking-wider transition-all shadow-lg mt-2"
                >
                  Add Lesson
                </button>
              </form>
          ...
          <div className="space-y-4">
            <h3 className="font-heading font-bold text-white text-base uppercase tracking-wider">Current Modules & Lessons Catalog</h3>
              ...
              {modules.map((mod) => (
                <div key={mod.id} className="glass-card rounded-2xl p-6 bg-[#0D0D0F]">
                  <div className="flex justify-between items-center mb-4 border-b border-card-border pb-3">
                    <div>
                      <h4 className="font-heading font-bold text-white text-base">{mod.title}</h4>
                      <p className="text-xs text-gray-400 font-light mt-0.5">{mod.description}</p>
                    </div>
                    <span className="text-[9px] font-bold bg-purple-500/10 text-purple-400 px-3 py-1.5 rounded-full border border-purple-500/20 uppercase tracking-widest">
                  ...
                  <div className="space-y-2">
                    {mod.lessons && mod.lessons.length > 0 ? (
                      mod.lessons.map((lesson) => (
                        <div key={lesson.id} className="p-3.5 rounded-xl bg-black border border-card-border/60 flex items-center justify-between text-xs">
                          <div>
                            <span className="font-bold text-white">{lesson.title}</span>
                            <span className="text-gray-500 font-mono ml-4">({lesson.duration})</span>
                            <span className="ml-3 text-[9px] bg-white/5 border border-white/5 text-gray-400 px-1.5 py-0.5 rounded font-bold uppercase tracking-wider">{lesson.difficulty}</span>
                          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 glass-card rounded-2xl p-6 bg-[#0D0D0F] space-y-4">
            ...
            <form onSubmit={handleCreateTip} className="space-y-4 text-xs">
              <div className="space-y-1">
                <label className="text-[9px] text-gray-400 uppercase font-bold tracking-wider">Tip Title</label>
                <input 
                  type="text" 
                  required 
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-[9px] text-gray-400 uppercase font-bold tracking-wider">Category</label>
                  <input 
                    type="text" 
                ...
                <div className="space-y-1">
                  <label className="text-[9px] text-gray-400 uppercase font-bold tracking-wider">Read Time</label>
                  <input 
                    type="text" 
              ...
              <div className="space-y-1">
                <label className="text-[9px] text-gray-400 uppercase font-bold tracking-wider">Intro Summary</label>
                <textarea 
                  rows={2}
                  required
              ...
              <div className="space-y-1">
                <label className="text-[9px] text-gray-400 uppercase font-bold tracking-wider">Step 1 Details</label>
                <input 
                  type="text" 
              ...
              <div className="space-y-1">
                <label className="text-[9px] text-gray-400 uppercase font-bold tracking-wider">Step 2 Details</label>
                <input 
                  type="text" 
          ...
          <div className="lg:col-span-7 space-y-4">
            <h3 className="font-heading font-bold text-white text-base uppercase tracking-wider font-bold">Active Design Tips</h3>
            
            <div className="space-y-3">
              {tips.map((tip) => (
                <div key={tip.id} className="glass-card p-5 rounded-2xl bg-[#0D0D0F] space-y-3 text-left">
                  <div className="flex justify-between items-center">
                    <span className="text-[9px] text-purple-400 font-bold bg-purple-500/10 px-2 py-0.5 rounded border border-purple-500/20 uppercase tracking-widest">{tip.category}</span>
                    <span className="text-xs text-gray-500 font-mono">{tip.readTime}</span>
                  </div>
                  <h4 className="font-heading font-bold text-white text-sm">{tip.title}</h4>
